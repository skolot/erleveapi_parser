-ifndef(EVEAPI_HRL).
-define(EVEAPI_HRL, "eveapi.hrl").

-define(REQUESTS, 
        [
         %% created by $ cat api.tmp | sed 's@\[\[\(.*\)/\(.*\)|.*\]\] \[https://api.eveonline.com/\(.*\) .*@{{'"'\1'"', '"'\2'"'}, "\3"},@'g
         
         %% Account

         {{'Account', 'AccountStatus'}, "Account/AccountStatus.xml.aspx"},
         {{'Account', 'APIKeyInfo'}, "Account/APIKeyInfo.xml.aspx"},
         {{'Account', 'Characters'}, "Account/Characters.xml.aspx"},

         %% Character

         {{'Char', 'AccountBalance'}, "Char/AccountBalance.xml.aspx"},
         {{'Char', 'AssetList'}, "Char/AssetList.xml.aspx"},
         {{'Char', 'Blueprints'}, "Char/Blueprints.xml.aspx"},
         {{'Char', 'CalendarEventAttendees'}, "Char/CalendarEventAttendees.xml.aspx"},
         {{'Char', 'CharacterSheet'}, "Char/CharacterSheet.xml.aspx"},
         {{'Char', 'ContactList'}, "Char/ContactList.xml.aspx"},
         {{'Char', 'ContactNotifications'}, "Char/ContactNotifications.xml.aspx"},
         {{'Char', 'Contracts'}, "Char/Contracts.xml.aspx"},
         {{'Char', 'ContractItems'}, "Char/ContractItems.xml.aspx"},
         {{'Char', 'ContractBids'}, "Char/ContractBids.xml.aspx"},
         {{'Char', 'FacWarStats'}, "Char/FacWarStats.xml.aspx"},
         {{'Char', 'IndustryJobs'}, "Char/IndustryJobs.xml.aspx"},
         {{'Char', 'IndustryJobsHistory'}, "Char/IndustryJobsHistory.xml.aspx"},
         {{'Char', 'KillMails'}, "Char/KillMails.xml.aspx"},
         {{'Char', 'Locations'}, "Char/Locations.xml.aspx"},
         {{'Char', 'MailBodies'}, "Char/MailBodies.xml.aspx"},
         {{'Char', 'MailingLists'}, "Char/MailingLists.xml.aspx"},
         {{'Char', 'MailMessages'}, "Char/MailMessages.xml.aspx"},
         {{'Char', 'MarketOrders'}, "Char/MarketOrders.xml.aspx"},
         {{'Char', 'Medals'}, "Char/Medals.xml.aspx"},
         {{'Char', 'Notifications'}, "Char/Notifications.xml.aspx"},
         {{'Char', 'NotificationTexts'}, "Char/NotificationTexts.xml.aspx"},
         {{'Char', 'PlanetaryColonies'}, "Char/PlanetaryColonies.xml.aspx"},
         {{'Char', 'PlanetaryPins'}, "Char/PlanetaryPins.xml.aspx"},
         {{'Char', 'PlanetaryRoutes'}, "Char/PlanetaryRoutes.xml.aspx"},
         {{'Char', 'PlanetaryLinks'}, "Char/PlanetaryLinks.xml.aspx"},
         {{'Char', 'Research'}, "Char/Research.xml.aspx"},
         {{'Char', 'SkillInTraining'}, "Char/SkillInTraining.xml.aspx"},
         {{'Char', 'SkillQueue'}, "Char/SkillQueue.xml.aspx"},
         {{'Char', 'Standings'}, "Char/Standings.xml.aspx"},
         {{'Char', 'UpcomingCalendarEvents'}, "Char/UpcomingCalendarEvents.xml.aspx"},
         {{'Char', 'WalletJournal'}, "Char/WalletJournal.xml.aspx"},
         {{'Char', 'WalletTransactions'}, "Char/WalletTransactions.xml.aspx"},

         %% Corporation

         {{'Corp', 'AccountBalance'}, "Corp/AccountBalance.xml.aspx"},
         {{'Corp', 'AssetList'}, "Corp/AssetList.xml.aspx"},
         {{'Corp', 'Blueprints'}, "Corp/Blueprints.xml.aspx"},
         {{'Corp', 'ContactList'}, "Corp/ContactList.xml.aspx"},
         {{'Corp', 'ContainerLog'}, "Corp/ContainerLog.xml.aspx"},
         {{'Corp', 'Contracts'}, "Corp/Contracts.xml.aspx"},
         {{'Corp', 'ContractItems'}, "Corp/ContractItems.xml.aspx"},
         {{'Corp', 'ContractBids'}, "Corp/ContractBids.xml.aspx"},
         {{'Corp', 'CorporationSheet'}, "Corp/CorporationSheet.xml.aspx"},
         {{'Corp', 'Facilities '}, "Corp/Facilities.xml.aspx"},
         {{'Corp', 'FacWarStats'}, "Corp/FacWarStats.xml.aspx"},
         {{'Corp', 'IndustryJobs'}, "Corp/IndustryJobs.xml.aspx"},
         {{'Corp', 'IndustryJobsHistory'}, "Corp/IndustryJobsHistory.xml.aspx"},
         {{'Corp', 'KillMails'}, "Corp/KillMails.xml.aspx"},
         {{'Corp', 'Locations'}, "Corp/Locations.xml.aspx"},
         {{'Corp', 'MarketOrders'}, "Corp/MarketOrders.xml.aspx"},
         {{'Corp', 'Medals'}, "Corp/Medals.xml.aspx"},
         {{'Corp', 'MemberMedals'}, "Corp/MemberMedals.xml.aspx"},
         {{'Corp', 'MemberSecurity'}, "Corp/MemberSecurity.xml.aspx"},
         {{'Corp', 'MemberSecurityLog'}, "Corp/MemberSecurityLog.xml.aspx"},
         {{'Corp', 'MemberTracking'}, "Corp/MemberTracking.xml.aspx"},
         {{'Corp', 'OutpostList'}, "Corp/OutpostList.xml.aspx"},
         {{'Corp', 'OutpostServiceDetail'}, "Corp/OutpostServiceDetail.xml.aspx"},
         {{'Corp', 'Shareholders'}, "Corp/Shareholders.xml.aspx"},
         {{'Corp', 'Standings'}, "Corp/Standings.xml.aspx"},
         {{'Corp', 'StarbaseDetail'}, "Corp/StarbaseDetail.xml.aspx"},
         {{'Corp', 'StarbaseList'}, "Corp/StarbaseList.xml.aspx"},
         {{'Corp', 'Titles'}, "Corp/Titles.xml.aspx"},
         {{'Corp', 'WalletJournal'}, "Corp/WalletJournal.xml.aspx"},
         {{'Corp', 'WalletTransactions'}, "Corp/WalletTransactions.xml.aspx"},
         ...
         {{'EVE', 'FacWarStats'}, "Eve/FacWarStats.xml.aspx"},
         {{'EVE', 'FacWarTopStats'}, "Eve/FacWarTopStats.xml.aspx"},
         {{'EVE', 'RefTypes'}, "Eve/RefTypes.xml.aspx"},
         {{'EVE', 'SkillTree'}, "Eve/SkillTree.xml.aspx"},
         {{'EVE', 'TypeName'}, "Eve/TypeName.xml.aspx"},

         %% Map

         {{'Map', 'FacWarSystems'}, "Map/FacWarSystems.xml.aspx"},
